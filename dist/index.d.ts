...
export type { PageShotConfig, PageConfig, Viewport, ColorScheme, BrowserName, ScreenshotFormat, StaticServerConfig, ScreenshotHookContext, BeforeScreenshotHook, ScreenshotResult, RunSummary, CliOptions, } from "./types/index.js";
