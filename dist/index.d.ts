...
export type { CapturistConfig, PageConfig, Viewport, ColorScheme, BrowserName, ScreenshotFormat, StaticServerConfig, ScreenshotHookContext, BeforeScreenshotHook, ScreenshotResult, RunSummary, CliOptions, CaptureHtmlOptions, } from "./types/index.js";
